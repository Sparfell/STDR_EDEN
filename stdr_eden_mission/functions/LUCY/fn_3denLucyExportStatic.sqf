...

{
	...
	_txt = format ["[%1,%2,%3,%4,[""NOTHING""],-1,%5] call GDC_fnc_lucySpawnStaticInf;",str (typeOf _x),[_pos],([(side _x)] call STDR_fnc_3denLucyConvertSide),str (unitPos _x),str ((_group get3DENAttribute "Init")#0)];
